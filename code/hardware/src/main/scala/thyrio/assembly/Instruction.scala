...
object Instruction {
  ...
  case class Expect(value: Register, expected: Register, expectMessage: String) extends Instruction(Opcode.EXPECT)

  case class GlobalLoad(rd: Register, addrlo: Register, addrmid: Register, addrhi: Register, offset: Long) extends
    Instruction(Opcode.GLOAD)
  case class GlobalStore(rs: Register, addrlo: Register, addrmid: Register, addrhi: Register, offset: Long) extends
