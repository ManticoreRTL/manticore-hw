...
class vcd(config: ISA) extends Module {
  ...
  axiMaster.io.M_AXI_BRESP   := io.m_axi_bank_0.BRESP
  axiMaster.io.M_AXI_RRESP   := io.m_axi_bank_0.RRESP
  axiMaster.io.M_AXI_BVALID  := io.m_axi_bank_0.BVALID
  axiMaster.io.M_AXI_WREADY  := io.m_axi_bank_0.WREADY
  axiMaster.io.M_AXI_RLAST   := io.m_axi_bank_0.RLAST
  axiMaster.io.M_AXI_ARREADY := io.m_axi_bank_0.ARREADY
  axiMaster.io.M_AXI_RRESP   := 0.U
  axiMaster.io.M_AXI_RDATA   := io.m_axi_bank_0.RDATA
  ...
  io.m_axi_bank_0.WLAST   := axiMaster.io.M_AXI_WLAST
  io.m_axi_bank_0.WVALID  := axiMaster.io.M_AXI_WVALID
  io.m_axi_bank_0.BREADY  := axiMaster.io.M_AXI_BREADY
  io.m_axi_bank_0.ARADDR  := axiMaster.io.M_AXI_ARADDR
  io.m_axi_bank_0.ARLEN   := axiMaster.io.M_AXI_ARLEN
  io.m_axi_bank_0.ARSIZE  := axiMaster.io.M_AXI_ARSIZE
  io.m_axi_bank_0.ARVALID := axiMaster.io.M_AXI_ARVALID

  axiMaster.io.M_AXI_RLAST  := io.m_axi_bank_0.RLAST
  axiMaster.io.M_AXI_RVALID := io.m_axi_bank_0.RVALID
  io.m_axi_bank_0.RREADY    := axiMaster.io.M_AXI_RREADY
